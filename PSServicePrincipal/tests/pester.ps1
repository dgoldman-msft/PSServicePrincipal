...
Remove-Module PSServicePrincipal -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\PSServicePrincipal.psd1"
Import-Module "$PSScriptRoot\..\PSServicePrincipal.psm1" -Force
