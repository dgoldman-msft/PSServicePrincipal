<#
	.SYNOPSIS
		Installs the PSServicePrincipal Module from github
		
	.DESCRIPTION
		This script installs the PSServicePrincipal Module from github.
